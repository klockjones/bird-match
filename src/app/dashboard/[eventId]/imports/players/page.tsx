  ...
  return (
    <main className="admin-page-shell">
      <div className="admin-hero">
        ...
        <p className="surface-copy" style={{ margin: 0 }}>{detail.title} 일정의 참가자 명단 CSV만 업로드합니다.</p>
      </div>
      ...
      <section className="admin-stack">
        <SectionHeader title="업로드 이력" description="어떤 CSV 명단 파일이 몇 건 반영되었는지 확인할 수 있습니다." />
